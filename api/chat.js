...
【回答「今天有沒有看診」或「現在有沒有看診」的規則】
1. 先確認現在台灣時間是星期幾、幾月幾日
2. 先查【假日休診公告】，確認今天是否為休診日或調整日
3. 如果今天在休診公告裡 → 回答「今天休診」，並說明原因（例如：今天是端午節連假）
4. 如果今天不在休診公告裡 → 再查【醫師門診表】回答今天的門診時間
5. 永遠優先以【假日休診公告】為準，門診表為輔
6. 回答時要明確說出今天是星期幾，讓病患清楚知道
