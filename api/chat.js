...
const FAQ = [
  // 地址、位置
  {
    ...
    answer: '您好，診所地址：新北市淡水區學府路36號2樓。如需交通指引，歡迎來電 02-26292000 詢問。'
  },
  // 電話
  {
    keywords: ['電話', '電話號碼', '聯絡', '打電話', '連絡'],
    answer: '您好，診所電話：02-26292000'
  },
  // 掛號費
  {
  ...
  {
    keywords: ['健保卡', '忘記帶', '沒帶'],
    answer: '您好，看診需攜帶健保卡。若未攜帶，當次費用須先自費，於就醫日起7日內補送健保卡即可辦理退費。'
  },
  // 門診時間
  {
  ...
  // 鞋墊
  {
    ...
    answer: '您好，診所提供客製化鞋墊製作服務，適合扁平足、拇指外翻、長期膝痛、習慣性腳扭傷等問題。詳情請來電 02-26292000 或至現場諮詢。'
  },
  // 護具
  {
    keywords: ['護具', '副木', '護腰'],
    answer: '您好，診所提供客製化護具製作，包含中風患者副木、腕隧道症候群手部護具、下背痛護腰等。詳情請來電 02-26292000 諮詢。'
  },
  // 停車
  {
    keywords: ['停車', '停車場', '車位'],
    answer: '您好，停車相關資訊請來電 02-26292000 詢問，我們將為您說明附近停車選擇。'
  },
  // Email
  {
    keywords: ['email', 'e-mail', '電子郵件', 'mail'],
    answer: '您好，診所的 Email：shikang.tsrc@msa.hinet.net'
  },
  // 看診進度
  {
